...
def build(image_set, args):
    ...
    mode = 'annotations'
    PATHS = {                   
        "train": (root / "data1/smoke_train_frames/", root / f'data1/smoke_train.json'),         #changed path to just include root for training images and json file for bounding boxes for training
        "val": (root / "data1/smoke_val_frames/", root / f'data1/smoke_val.json'),             #changed path to just include root for validation images and json file for bounding boxes for validation
    } # /home/cbj4040/Nemo/dataset/Nemodata/smoke_only/
