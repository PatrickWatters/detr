...
def build(image_set, args):
    ...
    mode = 'annotations'
    PATHS = {                   
        "train": (root / "FuegoData/train_frames/", root / f'FuegoData/train_fuego.json'),         #changed path to just include root for training images and json file for bounding boxes for training
        "val": (root / "FuegoData/train_frames/", root / f'FuegoData/test_fuego.json'),             #changed path to just include root for validation images and json file for bounding boxes for validation
    }
