...
def build(image_set, args):
    ...
    mode = 'instances'
    PATHS = {
        "train": (root / "train_images/", root2 / f'annotation_density_train.json'), # Amir [Jan 7, 2022] fixed with root2
        "val": (root / "val_images/", root2 / f'annotation_density_val.json'),
    } #"train": (root / "data3dummy/train_images/", root / f'data3dummy_rand/annotation_density_train2.json') # Amir [Jan 7, 2022] path was like this prior to the date
