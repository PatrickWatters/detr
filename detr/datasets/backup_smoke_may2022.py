...
def build(image_set, args):
    ...
    PATHS = { # Amir [Jan 7, 2022] added root2                  
        "train": (root / "train_images/", root2 / f'annotation_density_train.json'),         #changed path to just include root for training images and json file for bounding boxes for training
        "val": (root / "val_images/", root2 / f'annotation_density_val.json'),             #changed path to just include root for validation images and json file for bounding boxes for validation
    } # /home/yazdi/NEMO_DENSE/DATSETS/data?
